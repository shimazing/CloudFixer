...
class ShapeNetCore(data.Dataset):
    def __init__(self, config, dataset_name='shapenetcorev2', class_choice=None,
    ...
    def __getitem__(self, item):
        ...
        point_set = scale(point_set, 'unit_std')
        ...
        if self.segmentation:
            ...
            #return 'ScanObjectNN', 'sample', (point_set, label, name, file)
...
if __name__ == '__main__':
    ...
    d = ShapeNetCore(root=root, dataset_name=dataset_name, num_points=2048, split=split)
