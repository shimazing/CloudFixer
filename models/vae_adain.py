...
class Model(nn.Module):
    ...
    def forward(self,
            encode=False, x=None, class_label=None,
            global2style=False, style=None,
            decoder=False, first_arg=None, beta=None, context=None,
            ):

        if encode:
            return self.encode(x, class_label=class_label)
        if global2style:
            return self.global2style(style)
        if decoder:
            return self.decoder(first_arg, beta=beta, context=context, style=style)
