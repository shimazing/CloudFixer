            ...
            for corruption in ${CORRUPTION_LIST}; do
                for severity in ${SEVERITY_LIST}; do # "3 5"
                    ...
                    for method in ${METHOD_LIST}; do
                        ...
                        exp_name=eval_classifier_${classifier}_source_modelnet40_target_${dataset}_method_${method}_seed_${random_seed}_batch_size_${batch_size}
                        run_baselines
                    done
                done
            done
