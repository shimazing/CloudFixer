...
synsetid_to_class = {
    v:i for i,v in enumerate(synsetid)
}
...
class ShapeNet15kPointClouds(Dataset):
    def __init__(self,
        ...
        if 'all' in categories:
            self.synset_ids = sorted(list(cate_to_synsetid.values()))
        else:
        ...
        # else:  # normalize across the dataset
            ...
            #print(self.all_points.shape, "original data scale", (self.all_points ** 2).sum(axis=-1).max(axis=1))
